package fr.code.spotify_back.usercontext.application;
...
import fr.code.spotify_back.usercontext.mapper.UserMapper;
import fr.code.spotify_back.usercontext.repository.UserRepository;
...
public class UserService {
	...
	private User mapOauth2AttributesToUser(Map<String, Object> attributes) {
		...
		if(attributes.get("prefered_username") != null){
			username = ((String) attributes.get("prefered_username")).toLowerCase();
		}
		
		if(attributes.get("given_name") != null ) {
			user.setFirstName((String) attributes.get("given_username"));
